...
The SEO community celebrated as if it were a personal win. But Chesky completed the thought [in a tweet](https://twitter.com/bchesky) that was almost universally ignored:
...
When [27,000 people per month search "Airbnb in Ireland" while only 14,800 search "hotel in Ireland"](https://foundationinc.co/lab/airbnb-branding-success), that's not the result of link building. It's the result of a brand that became a verb. Kleenex. Jacuzzi. Frisbee. Airbnb. When a brand reaches that level, SEO becomes a consequence, not a cause.
...
The result: [1.1 million pages, Domain Authority 92, 18 million monthly organic visitors](https://foundationinc.co/lab/airbnb-branding-success). And traffic that survived the pandemic not because the SEO was good, but because the brand was strong enough to generate branded demand that no other platform could capture.
...
In 2023, Google Search Central [officially confirmed](https://developers.google.com/search/blog/2023/05/understanding-news-topic-authority) what SEOs had suspected for years: **topical authority is an explicit ranking signal**. Domains that demonstrate deep, consistent coverage of a topic cluster get preferential treatment in results for that cluster.

The academic foundation for this goes back to 2002, to a paper by Taher Haveliwala at Stanford: [Topic-Sensitive PageRank](http://www-cs-students.stanford.edu/~taherh/papers/topic-sensitive-pagerank.pdf). The core insight: a single authority score per domain is a blunt instrument. Topic-specific authority scores deliver substantially higher precision. Google has been refining that logic for over two decades.
...
Robert Zajonc published a paper in 1968 called ["Attitudinal Effects of Mere Exposure"](https://cdn.isr.umich.edu/pubFiles/historicPublications/Theattitudinaleffects_2360_.PDF) — now with over 6,000 citations — establishing something inconvenient for anyone who believes purchase decisions are rational: **repeated exposure to a stimulus increases positive attitude toward it, independently of conscious awareness**. No persuasion required. No click necessary.
...
Shapiro, MacInnis, and Heckler documented this in [a 1997 Journal of Consumer Research paper](https://academic.oup.com/jcr/article/24/1/94/1835396): incidental exposure to brand content increased the probability of the product entering the consumer's consideration set, even with no explicit memory of the exposure.
...
Kevin Indig, former Director of SEO at Shopify, [documented](https://www.growth-memo.com/p/how-to-measure-topical-authority) that pages with high topical authority gain traffic 57% faster than low-authority equivalents. HubSpot, after restructuring 12,000+ posts into topic clusters, [documented consistent ranking improvements](https://cdn2.hubspot.net/hubfs/53/assets/hubspot.com/research/reports/Topic%20Clusters%20SEO%20Report.pdf) — and that was before BERT and MUM made Google even more sensitive to topical depth.
...
Airbnb zeroed its marketing budget and kept 95% of its traffic because it had built something paid media can't buy: brand familiarity at scale, deposited over years of useful presence in the travel planning journey. [Ross Simmonds at Foundation](https://foundationinc.co/lab/airbnb-branding-success) put it well: the SEO moat Airbnb built is real — but what powers it is the brand, not the other way around.
