...
tags = ["cto", "team building", "carreira"]
url = "do-querer-fazer-parte-a-cto"
images = ["/blog/avelino-tony-buser.jpg"]
+++

![Do querer fazer parte a CTO](/blog/avelino-tony-buser.jpg#center)

Após ver a iniciativa que a [Buser](https://www.linkedin.com/company/buserbrasil/) teve de formar pessoas em casa com o programa [Buser Tech](https://blog.buser.com.br/novidades/buser-lanca-programa-capacitacao-profissionais-tecnologia/), eu quis me aproximar deles de alguma forma — não sabia como nem o que fazer, mas queria fazer parte da **"festa"**.
...
Conheço o [@Tony](https://www.linkedin.com/in/tonylampada/) há muitos anos e no final de 2021 tomei a liberdade de mandar mensagem para ele e expressar meu interesse.
...
O Tony está saindo da buser? Não, ele está voltando para próximo do time de engenharia e educação — onde ele sente que entrega muito mais resultado para a empresa. [Veja aqui](https://www.linkedin.com/pulse/vida-longa-ao-cto-tony-lampada/) a publicação que ele fez publicamente sobre esse movimento.
