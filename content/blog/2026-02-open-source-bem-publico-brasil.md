...
Na Alemanha, contribuidores lançaram uma [petição para reconhecer oficialmente contribuições open source como voluntariado para o bem público](https://www.openpetition.de/petition/online/anerkennung-der-arbeit-an-open-source-als-ehrenamt-in-deutschland). Isso habilitaria:
...
Mesmo sendo CTO _("poderia" estar longe do código)_ contribuo com muitos projetos open source há anos. O que eu vejo na prática: empresas consomem open source como commodity, devs brasileiros talentosíssimos contribuem no tempo livre (leia-se: madrugada), e não existe nenhum reconhecimento institucional — nem fiscal, nem legal, nem cultural.
...
A gente fala de _"contribuição", "comunidade", "pull request"_ — e o CEO, o investidor, o legislador não fazem a menor ideia do que isso significa na prática. Não sabem que aquela lib que sustenta o core do produto da empresa deles é mantida por um dev em Florianopolis às 2h da manhã.
...
- **Para "seu time"**: estragegia de atração e retenção de profissionais — cada pessoa se motiva por alguma coisa, open source pode e _é_ uma das coisas que sempre usei como estrategia de técnologia da empresas que passei
...
O [Samuel Berthe](https://www.linkedin.com/feed/update/urn:li:activity:7424710335871471616/) publicou no LinkedIn sobre a petição alemã e o incentivo fiscal francês, e me marcou perguntando como era no Brasil. Ao invés de responder só num comentário, [compartilhei minha opinião num post](https://www.linkedin.com/feed/update/urn:li:activity:7424743405362159617/). Mas o LinkedIn tem alcance limitado e conteúdo efêmero — resolvi transformar em blogpost para que a opinião fique acessível de verdade.
