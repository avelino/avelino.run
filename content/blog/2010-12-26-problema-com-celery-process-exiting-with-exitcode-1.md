...
aliases = ["/2010/12/problema-com-celery-process-exiting-exitcode-1"]
+++

Hoje estava rodando o Celery em um projeto e me deparei com um problema, o "process exiting with exitcode 1" quando dava start no Celery:
