...
tags = ["nginx", "proxy", "router"]
aliases = ["/2012/08/proxy-transparente-com-nginx"]
+++

Muitas pessoas usam Squid para fazer qual quer tipo de proxy, ate mesmo para proxy transparente para usar em servidor web, por exemplo:
